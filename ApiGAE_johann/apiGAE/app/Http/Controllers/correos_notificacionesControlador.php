...

{
    ...
    public function store(Request $request){
        ...
        if(!$correos_notificaciones){
            $data = [
                'message' => 'Error al crear el correos_notificaciones',
                'status' => 500
            ];
        ...
        $data = [
            'message' => 'correos_notificaciones creado Correctamente',
    ...
    public function show($id_correo ){
        ...
        if(!$correos_notificaciones){ 
            $data = [
                'message' => 'correos_notificaciones no encontrado',
                'status' => 404
            ];
            return response()->json($data, 404);
        }
    ...
    public function destroy($id_correo){
        ...
        $data = [
            'message' => 'correos_notificaciones Eliminado',
            'status' => 200
        ];
        return response()->json($data, 200);
    }
    ...
    public function update(Request $request, $id_correo){
       ...
       if(!$correos_notificaciones){
        ...
        $data = [
            'message' => 'correos_notificaciones Actualizado',
            'correos_notificaciones' => $correos_notificaciones,
            'status' => 200
        ];
