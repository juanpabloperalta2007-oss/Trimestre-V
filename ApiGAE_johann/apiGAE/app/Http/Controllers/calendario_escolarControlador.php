...

{
    ...
    public function store(Request $request){
        ...
        if(!$calendario_escolar){
            $data = [
                'message' => 'Error al crear el calendario_Escolar',
                'status' => 500
            ];
        ...
        $data = [
            'message' => 'calendario_escolar creado Correctamente',
    ...
    public function show($id_evento){
        ...
        if(!$calendario_escolar){ 
            $data = [
                'message' => 'calendario_escolar no encontrado',
                'status' => 404
            ];
            return response()->json($data, 404);
        }
    ...
    public function update(Request $request, $id_evento){
       ...
       if(!$calendario_escolar){
        ...
        $data = [
            'message' => 'calendario_escolar Actualizado',
            'calendario_escolar' => $calendario_escolar,
            'status' => 200
        ];
