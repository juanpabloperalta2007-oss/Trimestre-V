                  ...
                  <div className="card-body p-4">
                    <form onSubmit={guardarMateria}>
                      ...
                      <div className="d-grid gap-2">
                        ...
                        <a href="/MateriasAgregadas" 
                            className="btn btn-outline-primary text-center text-decoration-none"
                            style={{ color: '#0d6efd', backgroundColor: 'transparent', borderColor: '#0d6efd' }}
                            >
